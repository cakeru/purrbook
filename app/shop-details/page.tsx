        ...
        <section className="max-w-screen-2xl mx-auto px-12 grid grid-cols-1 md:grid-cols-12 gap-12 items-end mb-20">
          <div className="md:col-span-8 relative">
            <div className="overflow-hidden rounded-xl h-[500px]">
              <img
                alt="The Amber Sanctuary interior"
                className="w-full h-full object-cover transition-transform duration-700 hover:scale-105"
                data-alt="Lush boutique pet sanctuary interior with warm sunlight streaming through large windows, soft textures, and organic wood accents"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuCDFBDi6HGQzCXzH1h2bmS3hhikx9iL0u1UG3R3hKN9Nj16HJCLEE6mF7-31XeBEjO_peslKJ4UI9YH6U1zE4oRL6iSbOtmrQXOeJAitq445-AfaL764IrDuTLF94uqKgfb9_-3XFP8GNhzQqPGdY4Cg8T_vaNWdtwdYSECPkRJ-lCIH4tuHvEAVI82U4gRaRDvrtMcXDBAd3P4G9GvVW6fqrz1CepWIk99T9hqF1b6gN1kSE-C4bVE7gYaIoL_MAm_2F4bt_7D9ks8"
              />
            </div>
            <div className="absolute -bottom-10 left-10 bg-surface-container-lowest p-8 rounded-lg editorial-shadow max-w-md">
              ...
              <p className="text-on-surface-variant text-sm leading-relaxed mb-4">
                ...
                treatments meet boutique care.
              </p>
              <div className="flex items-center gap-4 text-xs font-semibold text-on-surface-variant">
                <span className="flex items-center gap-1">
                  <span className="material-symbols-outlined text-base">location_on</span> San
                  Vicente, Tarlac City, Tarlac
                </span>
                <span className="flex items-center gap-1">
                  <span className="material-symbols-outlined text-base">schedule</span> 09:00 -
                  19:00
                </span>
              </div>
            </div>
            ...
            <div className="col-span-2 bg-surface-container-low rounded-lg p-6 flex flex-col justify-between">
              ...
              <div>
                ...
                <p className="text-xs text-on-surface-variant">
                  Custom essential oil blends for every coat type.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-4 auto-rows-[150px]">
                <div className="col-span-2 row-span-2 rounded-lg overflow-hidden">
                  <img
                    alt="Golden retriever bath treatment"
                    className="w-full h-full object-cover"
                    data-alt="Close up of a fluffy golden retriever getting a gentle bubble bath in a modern porcelain tub"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuDmhn7TOJ6QFaE6qe4Mamra_nGzeJK8LQbh56MAWL2LGHtm7HjSR2Oc9IIBp7EgWqZdIEAruy6s7h4PJRBPhuxyp2esd_kI4PkVkKIjKzZWCz6nZzreNxkJJ7TbFQvq_CGgJm1GiXwzgJFUfSCfKFRaa-5LtYF1M6muusH7VodonIt4lp1sQExa9WPeK9Ajb3TrtkiTFV3bdwRPWB8fU2DaFiD41ykdpNm2WjbkiX39pvDXxxUS26cFA-mubeXY44oP02S2BZkCfq1P"
                  />
                </div>
                <div className="col-span-2 row-span-1 rounded-lg overflow-hidden">
                  <img
                    alt="Grooming tools flat lay"
                    className="w-full h-full object-cover"
                    data-alt="Minimalist pet grooming salon tools arranged neatly on a light wood surface"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuDvG0-KqArCtg9dcQuf75NtsMKESlDrRO2barclty9eNBl8e_dLef7AEQLULkwHCNhzxQBi7HnNvPTp2pJqLYPdh_6zp3gLYBo928pgpKcR-Ba257vpNxniDTiLYiIgq8q2IECiMa6W8QWQbYPG3pVnZT6IgLUlh_ghN6j2XhQQxeJsBH2x9FEGAEJYCtt7McNgXN-QgfuLB8tupzsLlR1ReMJTMjxMca4cJ0t2LajVeGzozAUYkhbGDDqfJkudwUc46UBgIGXbYq7i"
                  />
                </div>
                <div className="col-span-1 row-span-1 rounded-lg overflow-hidden">
                  <img
                    alt="White dog being brushed"
                    className="w-full h-full object-cover"
                    data-alt="A small white dog being carefully brushed in a sun-drenched pet salon"
                ...
                <div className="col-span-1 row-span-1 rounded-lg overflow-hidden relative group">
                  <img
                    alt="Groomer styling a poodle"
                    className="w-full h-full object-cover"
                    data-alt="Professional groomer working with a calm poodle in a high-end pet spa"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuCJ1CTSZCBkxhoD3uEXwlzEGNaoD5WKT38r81u5yNLY-qfYzqIFIBa4DSpybWhTA-2fMvouhjbUQx0Jzvy_1Q9bI-XO7MurndbMBhH5Sb7HrWLWH5lF7lsgJ1cQ9Aqj1_0MDk80K4_9YqrlGb2-Aygkbg0W_Kx1NR0l-PbE9U6qfKHZ8hNmHGqAf24Yu0wXlmtCmGz76RkwVuT1X14HORMBSO7xnaWkumdXlPW_PDANjQ6Z9wuzYYKXF9bAl647J89GF-AVMIL1Ea06"
                  />
            ...
            <div className="sticky top-32 bg-surface-container-lowest rounded-lg editorial-shadow p-8 space-y-8 border border-outline-variant/10">
              ...
              <div>
                ...
                <div className="flex justify-between">
                  <div className="flex flex-col items-center gap-2 group cursor-pointer active:scale-95 transition-all">
                    ...
                    <div className="w-10 h-10 flex items-center justify-center rounded-full text-xs font-bold border border-outline-variant/20 hover:bg-primary-container/20 transition-colors">
                      12
                    </div>
                  </div>
                  <div className="flex flex-col items-center gap-2 group cursor-pointer active:scale-95 transition-all">
                    <span className="text-[10px] text-outline font-bold">TUE</span>
                    <div className="w-10 h-10 flex items-center justify-center rounded-full text-xs font-bold bg-primary text-on-primary">
                      13
                    </div>
                  </div>
                  <div className="flex flex-col items-center gap-2 group cursor-pointer active:scale-95 transition-all">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button className="py-2.5 rounded-full border border-outline-variant/20 text-xs font-bold hover:bg-surface-container-high transition-all active:scale-95">
                    09:30 AM
                  </button>
                  <button className="py-2.5 rounded-full border border-outline-variant/20 text-xs font-bold hover:bg-surface-container-high transition-all active:scale-95">
                    11:00 AM
                  </button>
                  <button className="py-2.5 rounded-full border border-primary text-primary bg-primary-container/10 text-xs font-bold">
                    01:30 PM
                  </button>
                  <button className="py-2.5 rounded-full border border-outline-variant/20 text-xs font-bold hover:bg-surface-container-high transition-all active:scale-95">
                    03:00 PM
              ...
              <div className="bg-surface-container-low p-4 rounded-lg flex items-start gap-3">
                ...
                <p className="text-[11px] text-on-secondary-fixed-variant leading-normal">
                  Your booking includes PurrBook' Editorial Protection. Free cancellation up to 24
