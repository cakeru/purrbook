        ...
        <nav className="flex justify-between items-center px-12 py-4 max-w-screen-2xl mx-auto font-['Plus_Jakarta_Sans'] tracking-tight">
          <div className="flex items-center gap-12">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link
                className="text-amber-900 dark:text-amber-100 border-b-2 border-amber-700 pb-1 font-semibold"
                href="/profile"
              >
                Profile
              </Link>
            ...
            <div className="space-y-8">
              ...
              <section className="border-b border-outline-variant/10 pb-8">
                ...
                <div className="flex flex-wrap gap-3">
                  <Link
                    href="/pets/barnaby"
                    className="flex items-center gap-3 bg-surface-container-lowest border border-outline-variant/10 rounded-xl px-4 py-3 hover:border-primary transition-all active:scale-95 cursor-pointer group"
                  >
                    <img
                      ...
                      alt="Barnaby"
                      data-alt="Close-up of a fluffy golden retriever puppy with warm amber fur, soft natural light"
                  ...
                  <div className="flex items-center gap-3 bg-surface-container-lowest border border-outline-variant/10 rounded-xl px-4 py-3 hover:border-primary transition-all active:scale-95 cursor-pointer group">
                    <img
                      ...
                      alt="Luna"
                      data-alt="Elegant white Persian cat with silky long fur, studio portrait with soft ambient lighting"
                      className="w-10 h-10 rounded-lg object-cover flex-shrink-0"
                    />
                    <div className="flex-1">
                      <p className="font-headline font-bold text-on-surface text-sm group-hover:text-primary transition-colors">
                      ...
                      <p className="text-xs text-on-surface-variant">
                        Persian Cat · Female · 2 yrs
                      </p>
                    </div>
                    <Link
                      href="/schedule"
                      className="ml-2 text-xs text-primary font-bold hover:underline whitespace-nowrap"
                    >
                      Reserve →
                    </Link>
                  </div>
                  <AddCompanionModal variant="card" />
                </div>
              </section>
                    ...
                    <div className="flex items-center gap-4 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="flex flex-wrap items-center gap-2 mb-0.5">
                          ...
                          <span className="bg-tertiary-container text-on-tertiary-container text-xs font-bold px-2 py-0.5 rounded-full whitespace-nowrap">
                            Confirmed
                          </span>
                        </div>
                        <p className="text-xs text-on-surface-variant truncate">
                          "Royal Bath & Silk Cut" · Barnaby · Nov 14, 2024 · 11:15 AM
                        </p>
                      </div>
                    </div>
                    <Link
                      href="/schedule"
                      className="text-primary font-label font-bold text-xs hover:underline whitespace-nowrap flex-shrink-0 active:scale-95 transition-all"
                    >
                      Refine →
                    </Link>
                  </div>
                    ...
                    <div className="flex items-center gap-4 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="flex flex-wrap items-center gap-2 mb-0.5">
                          ...
                          <span className="bg-secondary-container text-on-secondary-container text-xs font-bold px-2 py-0.5 rounded-full whitespace-nowrap">
                            Pending
                          </span>
                        </div>
                        <p className="text-xs text-on-surface-variant truncate">
                          Breed-Specific Cut · Luna · Nov 21, 2024 · 10:30 AM
                        </p>
                      </div>
                    </div>
                    <Link
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <Link
                    href="/shop-details"
                    className="flex gap-4 p-3 rounded-xl border border-outline-variant/10 hover:border-primary bg-surface-container-lowest transition-all active:scale-95 group"
                  >
                    <img
                    ...
                    <span className="material-symbols-outlined text-on-surface-variant ml-auto self-center flex-shrink-0 text-base group-hover:text-primary transition-colors">
                      chevron_right
                    </span>
                  </Link>
                  {/* Vet Soucier */}
