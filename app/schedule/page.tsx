...
<p className="text-on-surface-variant text-lg md:text-xl mt-4 max-w-2xl font-light">
                Experience the "Tactile Sanctuary" – a bespoke grooming journey tailored for the discerning pet owner.
            </p>
</header>
...
<h3 className="text-on-surface font-semibold">Select Muse</h3>
</div>
</div>
<div className="flex items-center gap-6 group">
...
<button className="text-primary font-label text-sm font-bold uppercase tracking-widest active:scale-95 transition-all">+ Introduce a New Muse</button>
</div>
...
<img alt="Pet Profile" className="w-16 h-16 rounded-md object-cover grayscale-0 group-hover:scale-110 transition-transform duration-500" data-alt="Close up of a golden retriever smiling in soft morning light in a cozy living room setting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAqPLXkvBImvBgNNsUjdng4AAKjaYGdFqtuMjNkth3AvE0-I7rl15nOw3OK6HjgSrDG0LlRmOVKuVMN_O81glZEttBwTv2sVGzDA9Rgr-mds3DoEkSu0Zg2Rg8pWCYJ5-uuu-djeMf3YI5WKuuzlUV8kOUm9ROWhnlkzmSkZkx9uu4cOWoEuRzbHYXd0w1C_S4Dj-m9KcDIMJYyf16pKM4V9LQEA9bJIvxUgqZD0TI9rvXQUg6KJ5_9wdSmPjmNOj0Pryufghzvzg7B"/>
<div>
...
<button className="w-8 h-8 flex items-center justify-center hover:bg-surface-container rounded-full active:scale-95 transition-all"><span className="material-symbols-outlined text-sm">chevron_left</span></button>
<button className="w-8 h-8 flex items-center justify-center hover:bg-surface-container rounded-full active:scale-95 transition-all"><span className="material-symbols-outlined text-sm">chevron_right</span></button>
</div>
</div>
...
<button className="p-3 text-sm hover:bg-primary-container/20 rounded-full active:scale-95 transition-all">1</button>
<button className="p-3 text-sm hover:bg-primary-container/20 rounded-full active:scale-95 transition-all">2</button>
<button className="p-3 text-sm hover:bg-primary-container/20 rounded-full active:scale-95 transition-all">3</button>
{/* More days... */}
<button className="p-3 text-sm bg-primary text-on-primary rounded-full font-bold">14</button>
<button className="p-3 text-sm hover:bg-primary-container/20 rounded-full active:scale-95 transition-all">15</button>
<button className="p-3 text-sm hover:bg-primary-container/20 rounded-full active:scale-95 transition-all">16</button>
<button className="p-3 text-sm hover:bg-primary-container/20 rounded-full active:scale-95 transition-all">17</button>
</div>
</div>
...
<button className="px-5 py-2 bg-surface-container-lowest border border-outline-variant/15 text-sm rounded-full hover:border-primary transition-all active:scale-95">09:00 AM</button>
<button className="px-5 py-2 bg-surface-container-lowest border border-outline-variant/15 text-sm rounded-full hover:border-primary transition-all active:scale-95">10:30 AM</button>
<button className="px-5 py-2 bg-primary text-on-primary text-sm rounded-full font-bold shadow-md">11:15 AM</button>
<button className="px-5 py-2 bg-surface-container-lowest border border-outline-variant/15 text-sm rounded-full hover:border-primary transition-all active:scale-95">01:45 PM</button>
<button className="px-5 py-2 bg-surface-container-lowest border border-outline-variant/15 text-sm rounded-full hover:border-primary transition-all active:scale-95">03:00 PM</button>
<button className="px-5 py-2 opacity-30 cursor-not-allowed border border-outline-variant/15 text-sm rounded-full">04:30 PM</button>
</div>
</div>
</div>
</div>
<div className="flex justify-between pt-8 border-t border-outline-variant/10">
<button className="text-on-surface-variant font-label text-sm uppercase tracking-widest hover:text-on-surface">Cancel</button>
<Link href="/schedule/confirm" className="bg-on-surface text-surface px-12 py-4 rounded-full font-label font-bold uppercase tracking-widest hover:bg-primary transition-all shadow-lg active:scale-95">
