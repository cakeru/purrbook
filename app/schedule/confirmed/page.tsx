...
<section className="pt-20 pb-24 px-6 md:px-12 max-w-screen-2xl mx-auto text-center">
  ...
  <div className="max-w-lg mx-auto bg-surface-container-lowest border border-outline-variant/10 rounded-xl p-8 text-left mb-16 shadow-[0_8px_32px_rgba(48,51,48,0.06)]">
    <h3 className="font-headline font-bold text-on-surface text-center mb-6 text-lg">Booking Summary</h3>
    <div className="space-y-0">
      <div className="flex justify-between items-center border-b border-outline-variant/10 py-4">
        <span className="text-xs uppercase tracking-widest font-bold text-on-surface-variant">Sanctuary</span>
      ...
      <div className="flex justify-between items-center border-b border-outline-variant/10 py-4">
        ...
        <span className="text-sm font-semibold text-right max-w-[200px]">The "Royal Bath" &amp; Silk Cut</span>
      </div>
      <div className="flex justify-between items-center border-b border-outline-variant/10 py-4">
      ...
      <div className="flex justify-between items-center border-b border-outline-variant/10 py-4">
        <span className="text-xs uppercase tracking-widest font-bold text-on-surface-variant">Date &amp; Time</span>
        <span className="text-sm font-semibold">Nov 14, 2024 · 11:15 AM</span>
      </div>
      <div className="flex justify-between items-center pt-4">
        <span className="text-xs uppercase tracking-widest font-bold text-on-surface-variant">Total</span>
...
<div className="px-6 md:px-12 max-w-screen-2xl mx-auto">
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div className="bg-surface-container-lowest rounded-xl p-8 border border-outline-variant/10 space-y-5">
      ...
      <div>
        <span className="text-xs font-label font-bold uppercase tracking-widest text-on-surface-variant">Preparation</span>
        <h3 className="text-xl font-headline font-bold text-on-surface mt-1">Pre-Visit Grooming Tips</h3>
      </div>
      <p className="text-sm text-on-surface-variant leading-relaxed">
        Give Barnaby a light brush-out the evening before to remove surface tangles — this helps your groomer achieve a flawless finish without added stress. Avoid bathing at home 48 hours prior so the coat's natural oils remain intact for the sanctuary treatment.
      </p>
      <div className="pt-2 border-t border-outline-variant/10">
        <p className="text-xs text-on-surface-variant/70 italic">"A well-prepared coat is a groomer's greatest canvas."</p>
      </div>
    </div>
    ...
    <div className="bg-surface-container-lowest rounded-xl p-8 border border-outline-variant/10 space-y-5">
      ...
      <div>
        <span className="text-xs font-label font-bold uppercase tracking-widest text-on-surface-variant">Arrival Guide</span>
        <h3 className="text-xl font-headline font-bold text-on-surface mt-1">What to Bring</h3>
      </div>
      <ul className="text-sm text-on-surface-variant leading-relaxed space-y-3">
        <li className="flex items-start gap-2">
          <span className="material-symbols-outlined text-primary text-base mt-0.5 flex-shrink-0">check_small</span>
        ...
        <li className="flex items-start gap-2">
          <span className="material-symbols-outlined text-primary text-base mt-0.5 flex-shrink-0">check_small</span>
          Your booking reference: <strong className="text-on-surface font-bold">Ref #PB-20241114-0042</strong>
        </li>
        <li className="flex items-start gap-2">
          <span className="material-symbols-outlined text-primary text-base mt-0.5 flex-shrink-0">check_small</span>
    ...
    <div className="bg-surface-container-lowest rounded-xl p-8 border border-outline-variant/10 space-y-5">
      <div className="w-12 h-12 rounded-full bg-tertiary-container/40 flex items-center justify-center">
        <span className="material-symbols-outlined text-tertiary text-xl">person_celebrate</span>
      </div>
      <div>
        <span className="text-xs font-label font-bold uppercase tracking-widest text-on-surface-variant">Your Team</span>
        <h3 className="text-xl font-headline font-bold text-on-surface mt-1">Meet Your Groomer</h3>
      </div>
      <p className="text-sm text-on-surface-variant leading-relaxed">
        The Amber Sanctuary's senior groomer, Ana, holds a decade of breed-specific expertise. Known for a calm, intuitive approach with large breeds, she treats each session as a collaborative ritual — your pet's comfort is the throughline of every technique she employs.
      </p>
      <div className="flex items-center gap-3 pt-3 border-t border-outline-variant/10">
        ...
        <p className="text-xs text-on-surface-variant">4.9 rating · 200+ sessions · Golden Retriever specialist</p>
      </div>
    </div>
