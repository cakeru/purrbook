    ...
    <>
              ...
              <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant/10 p-6 space-y-6">
                ...
                <div className="border-b border-outline-variant/10 pb-6">
                  <div className="relative">
                    ...
                    <input
                      className="w-full bg-surface-container-low border-none rounded-lg pl-12 pr-4 py-3 focus:ring-2 focus:ring-primary/40 font-body"
                ...
                <div className="space-y-4 border-b border-outline-variant/10 pb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button className="px-5 py-2 rounded-full bg-primary text-on-primary font-label text-sm font-medium active:scale-95 transition-all">
                      Grooming
                    </button>
                    <button className="px-5 py-2 rounded-full bg-surface-container-highest text-on-surface font-label text-sm font-medium hover:bg-surface-container-high transition-all active:scale-95">
                      Boarding
                    </button>
                    <button className="px-5 py-2 rounded-full bg-surface-container-highest text-on-surface font-label text-sm font-medium hover:bg-surface-container-high transition-all active:scale-95">
                      Therapy
          ...
          <section className="flex-grow pb-24">
            <div className="flex justify-between items-end mb-10">
              ...
              <div className="flex items-center gap-4 bg-surface-container-low p-1 rounded-full">
                <button className="bg-surface-container-lowest px-6 py-2 rounded-full font-label text-sm font-semibold shadow-sm active:scale-95 transition-all">
                  Grid View
                </button>
                <button className="px-6 py-2 rounded-full font-label text-sm font-semibold text-on-surface-variant hover:text-on-surface transition-all active:scale-95">
                  Map Split
                </button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
              ...
              <div className="group bg-surface-container-lowest rounded-xl overflow-hidden hover:shadow-[0_12px_40px_rgba(48,51,48,0.08)] transition-all duration-500 xl:col-span-2 flex flex-col lg:flex-row border border-outline-variant/5">
                <div className="lg:w-2/5 h-80 lg:h-auto overflow-hidden relative">
                  <img
                    alt="Modern pet grooming spa interior"
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                    data-alt="luxury pet grooming studio with white marble floors, gold accents, and a professionally groomed golden retriever sitting on a velvet ottoman"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuA5aMG7PkZKuqy9TcX-YwdIgbHiIoRuyAq2DjVVf3NEs9tyvPlOo9_FUaA3cGuVd86Au6vVYB89SyWXPV1aYSH3_iOcQO28K-oCO5RZcGWKcdcGM39cl_TqCcwDowUeW3ktWQjQlXH-hJbEVHPq1IjpkO4W-mdYXGKql6dm56XrYr0hF_3EMS-bD5aQDlzUYMwEjz0_Xv3uZaw-1oZGA5OOZ1GyICSSSzwRE7exi0LBXn3sGmlTy2mPeVEsDQhfuVM90AbQX6w_YgGh"
                  />
                ...
                <div className="p-10 flex flex-col justify-between lg:w-3/5">
                  <div>
                    ...
                    <p className="text-on-surface-variant leading-relaxed text-lg mb-8 italic">
                      "Full-service pet salon and hotel in Tarlac City — grooming, boarding, and
                      daycare all under one roof."
                    </p>
                  ...
                  <div className="flex items-center justify-between border-t border-outline-variant/10 pt-6">
                    <div>
                      <p className="text-xs font-label font-bold text-on-surface-variant uppercase tracking-widest mb-1">
                        Pricing
                      </p>
                    ...
                    <Link
                      href="/shop-details"
                      className="bg-primary text-on-primary px-8 py-3 rounded-full font-label font-bold hover:shadow-lg hover:shadow-primary/20 transition-all active:scale-95"
                    >
                      Book Studio
                    </Link>
                  </div>
              ...
              <div className="bg-surface-container-lowest rounded-lg p-6 flex flex-col group border border-outline-variant/5">
                <div className="aspect-[4/3] rounded-lg overflow-hidden mb-6 relative">
                  <img
                    ...
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                    data-alt="close up of a professional groomer gently washing a white fluffy dog in a modern copper bathtub with soft morning light"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuCax9xrHUKSV0jb9-W7slGUygZjNXvdACyRuRtImSstGKH_eJk_ilV5RlFsoM21d7M-Y12J2OXchJZw6mv9xVeA-nhD4cMei6dvpZHIvGivHg3mGa1yKuREB2MP5SeRoJvUh6z7HgR32x1AmDEYNsi-CVaZc-mDGULM-7cf12i41OktYR-0LkyhRbOTsh1DFTUipUKwfhmBF2s0u_rBYvAlQRTdFfTHkdAwXzGTsgyr0_wK6Z-ZFYwk9vNTdkpW8obC-AmVcIBxf2Vg"
                  />
                ...
                <div className="flex-grow">
                  ...
                  <h3 className="text-xl font-headline font-bold text-on-surface mb-2">
                    Pups n Furr Pet Grooming
                  </h3>
                  <p className="text-sm text-on-surface-variant line-clamp-2 mb-6">
                    Friendly neighborhood grooming with gentle handling and personalized care for
                ...
                <div className="flex justify-between items-center pt-4 border-t border-outline-variant/10">
                  ...
                  <Link
                    href="/shop-details"
                    className="bg-surface-container-low text-on-surface px-5 py-2 rounded-full font-label font-bold text-sm group-hover:bg-primary group-hover:text-on-primary transition-all active:scale-95"
                  >
                    Reserve →
                  </Link>
                </div>
              ...
              <div className="bg-surface-container-lowest rounded-lg p-6 flex flex-col group border border-outline-variant/5">
                <div className="aspect-[4/3] rounded-lg overflow-hidden mb-6 relative">
                  <img
                    alt="Groomed pet"
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                    data-alt="a small toy poodle with an editorial level haircut sitting on a minimalist white stool against a soft beige studio background"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuDeDLCsZCI5xub3OrGKUTxV0eG-cgsl0rkIXo2JOwMB2BGWCZ88TofPNWIoT3g4tdTOJnEYbCGVleiwbRkH6rP-hayYcdr0Nx51txyfvprckoDWxplHGMKYBqZGX59qc4xt0VKjnqp5NerDwyU2KihXK_-baUS6nofeU2RSiPvRMeiakqm804YLgJNM3gt_tuBJpIM201nVLy1kHQzxKTz714Fa_fJofZAmeEtzpR7_PXOmonww1szQZ1FeORmYECRUNhJEcwv2PL-Y"
                  />
                  <div className="absolute top-4 left-4 bg-surface-container-lowest/90 backdrop-blur px-3 py-1 rounded-full text-xs font-bold text-primary tracking-widest uppercase">
                    Tarlac City
                  </div>
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-sm text-on-surface-variant line-clamp-2 mb-6">
                    Combined veterinary clinic and grooming center offering comprehensive pet health
                    and beauty care.
                  </p>
                </div>
                <div className="flex justify-between items-center pt-4 border-t border-outline-variant/10">
              ...
              <div className="bg-surface-container-lowest rounded-lg p-6 flex flex-col group border border-outline-variant/5">
                <div className="aspect-[4/3] rounded-lg overflow-hidden mb-6 relative">
                  <img
                    alt="Pet Station Grooming Salon"
              ...
              <div className="bg-surface-container-lowest rounded-lg p-6 flex flex-col group border border-outline-variant/5">
                <div className="aspect-[4/3] rounded-lg overflow-hidden mb-6 relative">
                  <img
                    alt="Paws and Furs Animal Clinic"
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-sm text-on-surface-variant line-clamp-2 mb-6">
                    Animal clinic offering wellness checks, vaccinations, and professional grooming
                ...
                <div className="flex justify-between items-center pt-4 border-t border-outline-variant/10">
                  <div className="flex items-center gap-1.5 text-sm text-on-surface-variant">
                    <span className="material-symbols-outlined text-base">near_me</span>
                    <span className="font-medium">0.2 km away</span>
                  </div>
                  <Link
                    href="/shop-details"
                    className="bg-surface-container-low text-on-surface px-5 py-2 rounded-full font-label font-bold text-sm group-hover:bg-primary group-hover:text-on-primary transition-all active:scale-95"
              ...
              <div className="bg-surface-container-lowest rounded-lg p-6 flex flex-col group border border-outline-variant/5">
                ...
                <div className="flex-grow">
                  ...
                  <h3 className="text-xl font-headline font-bold text-on-surface mb-2">
                    St. Bernard&#39;s Pet Shop
                  </h3>
                  <p className="text-sm text-on-surface-variant line-clamp-2 mb-6">
                    Trusted pet shop and grooming center in Matatalaib with quality care and
                    affordable rates for all pets.
                  </p>
                </div>
                <div className="flex justify-between items-center pt-4 border-t border-outline-variant/10">
                  <div className="flex items-center gap-1.5 text-sm text-on-surface-variant">
                    <span className="material-symbols-outlined text-base">near_me</span>
                    <span className="font-medium">1.5 km away</span>
                  </div>
                  <Link
                    href="/shop-details"
                    className="bg-surface-container-low text-on-surface px-5 py-2 rounded-full font-label font-bold text-sm group-hover:bg-primary group-hover:text-on-primary transition-all active:scale-95"
              ...
              <div className="bg-surface-container-lowest rounded-lg p-6 flex flex-col group border border-outline-variant/5">
                <div className="aspect-[4/3] rounded-lg overflow-hidden mb-6 relative">
                  <img
                    alt="Petvetgo Animal Clinic"
                    data-alt="Bright modern veterinary clinic interior with clean white surfaces and a calm dog resting on an examination table"
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuA5aMG7PkZKuqy9TcX-YwdIgbHiIoRuyAq2DjVVf3NEs9tyvPlOo9_FUaA3cGuVd86Au6vVYB89SyWXPV1aYSH3_iOcQO28K-oCO5RZcGWKcdcGM39cl_TqCcwDowUeW3ktWQjQlXH-hJbEVHPq1IjpkO4W-mdYXGKql6dm56XrYr0hF_3EMS-bD5aQDlzUYMwEjz0_Xv3uZaw-1oZGA5OOZ1GyICSSSzwRE7exi0LBXn3sGmlTy2mPeVEsDQhfuVM90AbQX6w_YgGh"
                  />
                  <button className="absolute top-4 right-4 w-10 h-10 rounded-full bg-white/80 backdrop-blur-md flex items-center justify-center text-primary hover:bg-white transition-all active:scale-95 shadow-sm">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-sm text-on-surface-variant line-clamp-2 mb-6">
                    Modern wellness center focused on preventive care and professional grooming for
                    your beloved pet.
                  </p>
                </div>
                <div className="flex justify-between items-center pt-4 border-t border-outline-variant/10">
                  <div className="flex items-center gap-1.5 text-sm text-on-surface-variant">
                    <span className="material-symbols-outlined text-base">near_me</span>
                    <span className="font-medium">0.9 km away</span>
                  </div>
                  <Link
                    href="/shop-details"
                    className="bg-surface-container-low text-on-surface px-5 py-2 rounded-full font-label font-bold text-sm group-hover:bg-primary group-hover:text-on-primary transition-all active:scale-95"
              ...
              <div className="bg-surface-container-lowest rounded-lg p-6 flex flex-col group border border-outline-variant/5">
                <div className="aspect-[4/3] rounded-lg overflow-hidden mb-6 relative">
                  <img
                    alt="CHIMICHOOMS PH"
                    data-alt="Whimsical pet grooming studio with pastel walls, fluffy rugs, and an adorably styled pomeranian posing on a plush salon chair"
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuCisizYA-UKaamDX6kW2add7sLhz-gimLA8hOCnbob3P_RE4FhUbTNHknE7mMITNtfW-VqTnESl5ig227WhCgc4NAEVgX5HBaRHi47Te7hJB66IomFrdyWErSzKLiQt4oZOdUkv12bD4bFMWDOrg8nAeAzZrNEPPCLgFyizmgYGt2Sy4hUID8LKfl9MyJ-zpowB5l9lpn64_KPngpltPs7vIXa-lvrqULibCFzIEbizpw6ZaDQsyO3DzMD-m1iyRVL5clEcZzuDKpR2"
                  />
                  <button className="absolute top-4 right-4 w-10 h-10 rounded-full bg-white/80 backdrop-blur-md flex items-center justify-center text-primary hover:bg-white transition-all active:scale-95 shadow-sm">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-sm text-on-surface-variant line-clamp-2 mb-6">
                    Specialty pet grooming shop offering unique styling and pampering services for
                ...
                <div className="flex justify-between items-center pt-4 border-t border-outline-variant/10">
                  <div className="flex items-center gap-1.5 text-sm text-on-surface-variant">
                    <span className="material-symbols-outlined text-base">near_me</span>
                    <span className="font-medium">0.6 km away</span>
                  </div>
                  <Link
                    href="/shop-details"
                    className="bg-surface-container-low text-on-surface px-5 py-2 rounded-full font-label font-bold text-sm group-hover:bg-primary group-hover:text-on-primary transition-all active:scale-95"
              ...
              <div className="bg-surface-container-lowest rounded-lg p-6 flex flex-col group border border-outline-variant/5">
                <div className="aspect-[4/3] rounded-lg overflow-hidden mb-6 relative">
                  <img
                    alt="Paws and Claws Pet Supplies"
                    data-alt="Bright airy pet supplies shop with neatly arranged shelves of premium pet food, colorful leashes, and artisanal pet accessories"
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuAD9OTcCHwYhTAYeRgmlAvpMCP6fXRTN6u4mniB5rO1-omCJkM-6ly7SySSvWMe8FmFFI6cJ0e31ova3gJI5I-37sLEDn0Hu_K2LEQ7ZnMHM0D5HObxgpcl5E2fDMCSImzIx09nqWxusRoQQRvsHO0hTlszDa-JgUXEZvzXYqkrZyESUmZDduAU5MNKxcz_PDRdgmz8k4hVtc5MiSFXMBAb51mRzjtFlltLo0-iEN9M14y0O_vvmJOHEXMjpOOio-sxNHeWH1x8Zu-D"
                  />
                  <button className="absolute top-4 right-4 w-10 h-10 rounded-full bg-white/80 backdrop-blur-md flex items-center justify-center text-primary hover:bg-white transition-all active:scale-95 shadow-sm">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-sm text-on-surface-variant line-clamp-2 mb-6">
                    Complete pet supplies store with grooming services, stocking premium food,
                ...
                <div className="flex justify-between items-center pt-4 border-t border-outline-variant/10">
                  <div className="flex items-center gap-1.5 text-sm text-on-surface-variant">
                    <span className="material-symbols-outlined text-base">near_me</span>
                    <span className="font-medium">0.8 km away</span>
                  </div>
                  <Link
                    href="/shop-details"
                    className="bg-surface-container-low text-on-surface px-5 py-2 rounded-full font-label font-bold text-sm group-hover:bg-primary group-hover:text-on-primary transition-all active:scale-95"
              ...
              <div className="bg-surface-container-lowest rounded-lg p-6 flex flex-col group border border-outline-variant/5">
                <div className="aspect-[4/3] rounded-lg overflow-hidden mb-6 relative">
                  <img
                    alt="Petorria Animal Clinic and Grooming"
                    data-alt="Warm modern veterinary clinic reception area with natural wood paneling, lush plants, and a relaxed golden retriever waiting calmly on a bench"
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuDT48xD8i_fFqMT5oji6et_7cF6boFYVww5YaRsXMrEHRj1NFiKpAKnL6X1eDPkXbzL2WyVRsPlWv43hLuxMqD7mOp_iMTFPwXPS9RczIjUCo6zMV5vR9yBq8S8_6sqHva0glprtyCzgDfwqPqrcbg73UQPoH_q7jJC1eVFH1FwW_JLnwmy3cwHOOFxOrw1E-DfPdgz8EjgB8u1yzmPV7V1efwNvwP3rVCvlKlOUCUZ1n1KvcrJOIIVu1Vh4iI3Yvhl8FqFafpBR6yJ"
                  />
                  <button className="absolute top-4 right-4 w-10 h-10 rounded-full bg-white/80 backdrop-blur-md flex items-center justify-center text-primary hover:bg-white transition-all active:scale-95 shadow-sm">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-sm text-on-surface-variant line-clamp-2 mb-6">
                    Full-service animal clinic and grooming center providing medical care, wellness
                    checks, and top-tier grooming.
                  </p>
                </div>
                <div className="flex justify-between items-center pt-4 border-t border-outline-variant/10">
                  <div className="flex items-center gap-1.5 text-sm text-on-surface-variant">
                    <span className="material-symbols-outlined text-base">near_me</span>
                    <span className="font-medium">0.3 km away</span>
                  </div>
                  <Link
                    href="/shop-details"
                    className="bg-surface-container-low text-on-surface px-5 py-2 rounded-full font-label font-bold text-sm group-hover:bg-primary group-hover:text-on-primary transition-all active:scale-95"
              ...
              <div className="bg-surface-container-lowest rounded-lg p-6 flex flex-col group border border-outline-variant/5">
                <div className="aspect-[4/3] rounded-lg overflow-hidden mb-6 relative">
                  <img
                    alt="Matias Pet Shop"
                    data-alt="Charming neighborhood pet shop with a handpainted wooden sign, baskets of organic dog treats, and sunlight streaming through the front window"
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuDeDLCsZCI5xub3OrGKUTxV0eG-cgsl0rkIXo2JOwMB2BGWCZ88TofPNWIoT3g4tdTOJnEYbCGVleiwbRkH6rP-hayYcdr0Nx51txyfvprckoDWxplHGMKYBqZGX59qc4xt0VKjnqp5NerDwyU2KihXK_-baUS6nofeU2RSiPvRMeiakqm804YLgJNM3gt_tuBJpIM201nVLy1kHQzxKTz714Fa_fJofZAmeEtzpR7_PXOmonww1szQZ1FeORmYECRUNhJEcwv2PL-Y"
                  />
                  <button className="absolute top-4 right-4 w-10 h-10 rounded-full bg-white/80 backdrop-blur-md flex items-center justify-center text-primary hover:bg-white transition-all active:scale-95 shadow-sm">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-sm text-on-surface-variant line-clamp-2 mb-6">
                    Community-trusted pet shop offering a wide range of pet supplies, food, and
              ...
              <div className="bg-surface-container-lowest rounded-lg p-6 flex flex-col group border border-outline-variant/5">
                <div className="aspect-[4/3] rounded-lg overflow-hidden mb-6 relative">
                  <img
                    alt="J and D Petshop"
                    data-alt="Cozy family-run pet shop with colorful bird cages, terrariums, and a tabby cat lounging lazily on the store counter"
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuA5aMG7PkZKuqy9TcX-YwdIgbHiIoRuyAq2DjVVf3NEs9tyvPlOo9_FUaA3cGuVd86Au6vVYB89SyWXPV1aYSH3_iOcQO28K-oCO5RZcGWKcdcGM39cl_TqCcwDowUeW3ktWQjQlXH-hJbEVHPq1IjpkO4W-mdYXGKql6dm56XrYr0hF_3EMS-bD5aQDlzUYMwEjz0_Xv3uZaw-1oZGA5OOZ1GyICSSSzwRE7exi0LBXn3sGmlTy2mPeVEsDQhfuVM90AbQX6w_YgGh"
                  />
                  <button className="absolute top-4 right-4 w-10 h-10 rounded-full bg-white/80 backdrop-blur-md flex items-center justify-center text-primary hover:bg-white transition-all active:scale-95 shadow-sm">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-sm text-on-surface-variant line-clamp-2 mb-6">
                    Neighborhood pet shop with a friendly atmosphere, stocking essentials and treats
              ...
              <div className="bg-surface-container-lowest rounded-lg p-6 flex flex-col group border border-outline-variant/5">
                <div className="aspect-[4/3] rounded-lg overflow-hidden mb-6 relative">
                  <img
                    alt="Angeles Pet Care Center Tarlac"
                    data-alt="Spacious professional pet care center with a dedicated grooming suite, waiting area with plush seating, and a friendly staff member attending to a fluffy shih tzu"
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuCax9xrHUKSV0jb9-W7slGUygZjNXvdACyRuRtImSstGKH_eJk_ilV5RlFsoM21d7M-Y12J2OXchJZw6mv9xVeA-nhD4cMei6dvpZHIvGivHg3mGa1yKuREB2MP5SeRoJvUh6z7HgR32x1AmDEYNsi-CVaZc-mDGULM-7cf12i41OktYR-0LkyhRbOTsh1DFTUipUKwfhmBF2s0u_rBYvAlQRTdFfTHkdAwXzGTsgyr0_wK6Z-ZFYwk9vNTdkpW8obC-AmVcIBxf2Vg"
                  />
                  <button className="absolute top-4 right-4 w-10 h-10 rounded-full bg-white/80 backdrop-blur-md flex items-center justify-center text-primary hover:bg-white transition-all active:scale-95 shadow-sm">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-sm text-on-surface-variant line-clamp-2 mb-6">
                    Dedicated pet care center offering grooming, veterinary consultations, and
                    wellness services for all breeds.
                  </p>
                </div>
                <div className="flex justify-between items-center pt-4 border-t border-outline-variant/10">
                  <div className="flex items-center gap-1.5 text-sm text-on-surface-variant">
                    <span className="material-symbols-outlined text-base">near_me</span>
                    <span className="font-medium">1.0 km away</span>
                  </div>
                  <Link
                    href="/shop-details"
                    className="bg-surface-container-low text-on-surface px-5 py-2 rounded-full font-label font-bold text-sm group-hover:bg-primary group-hover:text-on-primary transition-all active:scale-95"
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  <div className="bg-white/90 backdrop-blur-xl p-8 rounded-xl shadow-2xl text-center max-w-sm pointer-events-auto">
                    ...
                    <p className="text-sm text-on-surface-variant mb-6">
                      Toggle the interactive map to see real-time availability in your immediate
                      neighborhood.
                    </p>
                    <button className="bg-on-surface text-surface px-8 py-3 rounded-full font-label font-bold hover:bg-black transition-all active:scale-95">
                      Expand Map View
                    </button>
                  </div>
                </div>
      ...
      <footer className="w-full mt-20 bg-stone-100 dark:bg-stone-950">
        <div className="flex flex-col md:flex-row justify-between items-center px-12 py-16 gap-8 border-t border-stone-200/20 max-w-screen-2xl mx-auto">
          <span className="text-lg font-black text-amber-900 dark:text-amber-200 font-headline uppercase tracking-widest italic">
            PurrBook
          </span>
          <div className="flex flex-wrap justify-center gap-10 font-['Be_Vietnam_Pro'] text-sm uppercase tracking-widest">
            <a
              className="text-stone-500 dark:text-stone-500 hover:text-amber-600 dark:hover:text-amber-400 transition-colors opacity-80 hover:opacity-100"
              href="#"
            >
              About Us
            </a>
